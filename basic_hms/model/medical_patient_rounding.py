...
class medical_patient_rounding(models.Model):
    ...
    medical_inpatient_registration = fields.Many2one('medical.inpatient.registration', string="Registration Code",
                                                     required=True)
    ...
    medical_supplies_ids = fields.One2many('medical.patient.rounding.medical_supply',
                                           'medical_patient_rounding_medical_supply_id', string='Medical Supplier')

...
class medical_patient_diseases(models.Model):
    ...
    status_of_the_disease = fields.Selection(
        [('chronic', 'Chronic'), ('status quo', 'Status Quo'), ('healed', 'Healed'), ('improving', 'Improving'),
         ('worsening', 'Worsening')], 'Status of the disease')
    ...
    allergy_type = fields.Selection(
        [('drug_allergy', 'Drug Allergy'), ('food_allergy', 'Food Allergy'), ('misc', 'Misc')], 'Allergy_type')
